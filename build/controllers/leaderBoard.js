...
var leaderBoardService_1 = require("../service/leaderBoardService");
var LeaderBoard = /** @class */ (function () {
    function LeaderBoard() {
    }
    LeaderBoard.prototype.getLeaderBoard = function (req, res) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var page, limit, buildQuery, result, totalCount, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, leaderBoardService_1.leaderBoardService.getLeaderBoardData(buildQuery)];
                    case 1:
                        result = _c.sent();
